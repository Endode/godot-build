...
scons platform=linuxbsd target=editor production=yes use_lto=yes d3d12=no deprecated=yes # If deprecated=no then the mono glue (build_assemblies.py specifically) fails
