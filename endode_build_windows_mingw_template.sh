...
scons platform=windows target=template_release production=yes use_mingw=yes use_llvm=yes use_lto=yes lto=thin d3d12=yes winrt=no accesskit=no angle=no
