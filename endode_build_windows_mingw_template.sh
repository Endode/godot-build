...
export PATH="/home/endode/Programs/llvm-mingw-20250417-msvcrt-ubuntu-22.04-x86_64/bin:$PATH"
scons platform=windows target=template_release production=yes use_mingw=yes use_llvm=yes use_lto=yes lto=thin d3d12=no
