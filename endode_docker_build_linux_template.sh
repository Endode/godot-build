...
scons platform=linuxbsd target=template_release production=yes use_lto=yes lto=thin use_llvm=yes d3d12=no AR=llvm-ar RANLIB=llvm-ranlib LINKFLAGS="-fuse-ld=lld" use_lld=yes
